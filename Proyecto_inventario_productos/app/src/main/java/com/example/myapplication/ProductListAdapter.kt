...
class ProductListAdapter(var lstProductos: List<Producto>, private val verInfo: (prodId : Int) -> Unit): RecyclerView.Adapter<ProductListAdapter.ProductListViewHolder>() {
